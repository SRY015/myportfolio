  ...
  return (
    <div className="w-11/12 mr-auto ml-auto py-5">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-10">
        ...
        >
          <FaHtml5 className="text-[#E4542C] text-[80px] md:text-[100px] mr-auto ml-auto" />
          <p className="text-[20px] md:text-4xl text-[#E4542C] text-center mt-2">
            HTML
          </p>
        </div>
        <div
        ...
        >
          <FaCss3Alt className="text-[#0873BF] text-[80px] md:text-[100px] mr-auto ml-auto" />
          <p className="text-[20px] md:text-4xl text-[#0873BF] text-center mt-2">
            CSS
          </p>
        </div>
        <div
        ...
        >
          <TbBrandJavascript className="text-[#F4E225] text-[80px] md:text-[100px] mr-auto ml-auto" />
          <p className="text-[20px] md:text-4xl text-[#F4E225] text-center mt-2">
            JavaScript
          </p>
        </div>
        <div
        ...
        >
          <RiTailwindCssFill className="text-[#38BDF8] text-[80px] md:text-[100px] mr-auto ml-auto" />
          <p className="text-[20px] md:text-4xl text-[#38BDF8] text-center mt-2">
            TailWind CSS
          </p>
        </div>
        <div
        ...
        >
          <FaBootstrap className="text-[#7A11F7] text-[80px] md:text-[100px] mr-auto ml-auto" />
          <p className="text-[20px] md:text-4xl text-[#7A11F7] text-center mt-2">
            Bootstrap
          </p>
        </div>
        <div
        ...
        >
          <FaJava className="text-orange-600 text-[80px] md:text-[100px] mr-auto ml-auto" />
          <p className="text-[20px] md:text-4xl text-orange-600 text-center mt-2">
            Java Programming
          </p>
        </div>
        <div
        ...
        >
          <FaCopyright className="text-[#303C96] text-[80px] md:text-[100px] mr-auto ml-auto" />
          <p className="text-[20px] md:text-4xl text-[#303C96] text-center mt-2">
            C Programming
          </p>
        </div>
        <div
        ...
        >
          <SiPhp className="text-[#7377AD] text-[80px] md:text-[100px] mr-auto ml-auto" />
          <p className="text-[20px] md:text-4xl text-[#7377AD] text-center mt-2">
            PHP
          </p>
        </div>
        <div
        ...
        >
          <FaReact className="text-[#A31545] text-[80px] md:text-[100px] mr-auto ml-auto" />
          <p className="text-[20px] md:text-4xl text-[#A31545] text-center mt-2">
            React.JS
          </p>
        </div>
        <div
        ...
        >
          <FaNodeJs className="text-[#8FC708] text-[80px] md:text-[100px] mr-auto ml-auto" />
          <p className="text-[20px] md:text-4xl text-[#8FC708] text-center mt-2">
            Node.JS
          </p>
        </div>
        <div
        ...
        >
          <GrMysql className="text-[#085970] text-[80px] md:text-[100px] mr-auto ml-auto" />
          <p className="text-[20px] md:text-4xl text-[#085970] text-center mt-2">
            MySql
          </p>
        </div>
        <div
        ...
        >
          <SiMongodb className="text-[#08EE69] text-[80px] md:text-[100px] mr-auto ml-auto" />
          <p className="text-[20px] md:text-4xl text-[#08EE69] text-center mt-2">
            mongoDB
          </p>
        </div>
      </div>
